  ...
  return (
    <View className="flex-1 bg-surface-inset dark:bg-surface-dark-inset">
      <ScrollView
        ...
        // insets.top/bottom technically make this "dynamic," but safe-area
        // insets don't change mid-session in this app (portrait-locked, no
        // keyboard-avoiding scroll here) — contentInset is iOS-only, so
        // switching to it would silently drop Android's safe-area padding
        // rather than fix a jump that doesn't happen in practice.
